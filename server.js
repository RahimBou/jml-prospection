...
async function api(pathname,url){
  ...
  if(pathname==="/api/radar"){
    ...
    const candidates=dpeRows.map((p,index)=>{
      ...
      if(match.matchQuality==="exact"&&unitConfidence==="probable"&&saleAge!==null){
